...
3. **Pick the smallest LLM-using surface** you have and wire `observe(...)` + a generation observation (`startObservation(..., { asType: "generation" })`) first. Get one trace before you do anything else.
