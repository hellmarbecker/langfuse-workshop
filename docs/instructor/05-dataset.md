...
- Call out why `expectedOutput` has two fields: `idealAnswer` feeds the Correctness judge, and `expectedKeywords` feeds the deterministic code evaluator in the next chapter.
